const LESSONS = [
{
  ...
  vocab:[{w:"pin",icon:"📌"},{w:"tin",icon:"🥫"},{w:"nap",icon:"😴"},{w:"sit",icon:"🪑"}],  story:["A pin is in a tin.","Tim sat.","Sam sat."], patterns:[],
...
},
{
  ...
  vocab:[{w:"cat",icon:"🐱"},{w:"pen",icon:"🖊️"},{w:"pig",icon:"🐷"},{w:"dog",icon:"🐶"},{w:"sun",icon:"☀️"}],  story:["The cat is on a red mat.","A dog is in the sun.","The pig is in a pen."],patterns:[],
...
},
{
  ...
  vocab:[{w:"ship",icon:"🚢"},{w:"chip",icon:"🍟"},{w:"fish",icon:"🐟"},{w:"duck",icon:"🦆"},{w:"sock",icon:"🧦"}],  story:["This duck is in the shop.","The duck has a red sock.","A fish is in the dish."],patterns:["sh","ch","th","ng","ck"],
...
},
{
  ...
  vocab:[{w:"frog",icon:"🐸"},{w:"swim",icon:"🏊"},{w:"clap",icon:"👏"},{w:"black",icon:"⬛"},{w:"stop",icon:"🛑"}],  story:["A black frog is on a flat log.","It can swim.","It slips and drops in."],patterns:["st","sp","bl","cl","fl","gr"],
...
},
{
  ...
  vocab:[{w:"bike",icon:"🚲"},{w:"kite",icon:"🪁"},{w:"home",icon:"🏠"},{w:"cube",icon:"🧊"},{w:"game",icon:"🎲"}],  story:["Mike has a bike.","He can ride home.","He has a red kite."],patterns:["a_e","i_e","o_e","u_e"],
...
},
{
  ...
  vocab:[{w:"green",icon:"🟢"},{w:"rain",icon:"🌧️"},{w:"read",icon:"📖"},{w:"play",icon:"🎮"},{w:"team",icon:"👥"}],  story:["It is a rainy day.","Mia and Lee stay in.","They read and play a game."],patterns:["ee","ea","ai","ay"],
...
},
{
  ...
  vocab:[{w:"boat",icon:"⛵"},{w:"snow",icon:"❄️"},{w:"moon",icon:"🌙"},{w:"book",icon:"📕"},{w:"coat",icon:"🧥"}],  story:["Joe has a yellow coat.","He goes on a boat.","He looks at the moon."],patterns:["oa","ow","oo"],
...
},
{
  ...
  vocab:[{w:"school",icon:"🏫"},{w:"book",icon:"📗"},{w:"friend",icon:"🧑‍🤝‍🧑"},{w:"read",icon:"📖"},{w:"smile",icon:"😊"}],  story:["One day, Sam and Mia are at school.","Sam has a green book.","Mia said, ‘Come and read with me.’","They sit, read and smile.","It was a good day."],patterns:[],
